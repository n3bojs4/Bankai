...
then
    echo "gpg command does not exists, please install gnupg package. Scritpt exiting."
    exit 1
fi

if ! command -v wget &> /dev/null
then
    echo "wget command does not exists, please install wget package. Scritpt exiting."
    exit 1
fi
